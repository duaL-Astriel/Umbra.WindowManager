...
public class GameWindowAdapterTests
{
    ...
    [InlineData("Inventory", "InventoryGrid0E", true)]
    ...
    [InlineData("Inventory", "InventoryEventGrid0E", true)]
    [InlineData("Inventory", "InventoryCrystalGrid", true)]
    [InlineData("Inventory", "InventoryBuddy", true)]
    [InlineData("InventoryExpansion", "InventoryGrid0E", true)]
    [InlineData("InventoryExpansion", "InventoryEventGrid0E", true)]
    [InlineData("InventoryExpansion", "InventoryCrystalGrid", true)]
    [InlineData("InventoryLarge", "InventoryGrid0", true)]
    [InlineData("InventoryLarge", "InventoryCrystalGrid", true)]
    ...
    [InlineData("InventoryGrid0E", true)]
    [InlineData("InventoryEventGrid0E", true)]
    [InlineData("InventoryCrystalGrid", true)]
    [InlineData("InventoryLarge", false)]
    [InlineData("InventoryExpansion", false)]
    [InlineData("InventoryBuddy", false)]
